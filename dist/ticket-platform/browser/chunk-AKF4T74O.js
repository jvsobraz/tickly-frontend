import {
  FlashSaleService
} from "./chunk-ZI3DQQRU.js";
import {
  WaitlistService
} from "./chunk-NE7736LT.js";
import {
  EventService
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_For_17_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_41_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_1_Template, 5, 1, "div", 19);
    \u0275\u0275elementStart(2, "div", 20)(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_5_Template, 2, 1, "p");
    \u0275\u0275elementStart(6, "div", 21);
    \u0275\u0275template(7, EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_7_Template, 9, 12)(8, EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_8_Template, 2, 0)(9, EventDetailComponent_Conditional_1_For_41_Conditional_0_Conditional_9_Template, 3, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "small", 22);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "mat-form-field", 23)(13, "mat-label");
    \u0275\u0275text(14, "Qtd");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-select", 24);
    \u0275\u0275twoWayListener("ngModelChange", function EventDetailComponent_Conditional_1_For_41_Conditional_0_Template_mat_select_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275repeaterCreate(16, EventDetailComponent_Conditional_1_For_41_Conditional_0_For_17_Template, 2, 2, "mat-option", 25, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
...
function EventDetailComponent_Conditional_1_For_41_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 35);
  }
}
...
function EventDetailComponent_Conditional_1_For_41_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 32)(1, "div", 20)(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(7, EventDetailComponent_Conditional_1_For_41_Conditional_1_Conditional_7_Template, 1, 0, "mat-progress-spinner", 35)(8, EventDetailComponent_Conditional_1_For_41_Conditional_1_Conditional_8_Template, 3, 0);
    \u0275\u0275elementEnd()();
...
function EventDetailComponent_Conditional_1_For_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, EventDetailComponent_Conditional_1_For_41_Conditional_0_Template, 19, 8)(1, EventDetailComponent_Conditional_1_For_41_Conditional_1_Template, 10, 3);
  }
  if (rf & 2) {
...
function EventDetailComponent_Conditional_1_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "Resumo:");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, EventDetailComponent_Conditional_1_Conditional_42_For_4_Template, 6, 6, "div", 37, _forTrack1);
    \u0275\u0275element(5, "mat-divider");
    \u0275\u0275elementStart(6, "div", 38)(7, "strong");
    \u0275\u0275text(8, "Total");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-radio-group", 40);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EventDetailComponent, { className: "EventDetailComponent", filePath: "src\\app\\features\\events\\event-detail\\event-detail.component.ts", lineNumber: 226 });
})();
export {
  EventDetailComponent
};
//# sourceMappingURL=chunk-AKF4T74O.js.map
