...
// src/app/core/services/ticket-transfer.service.ts
var TicketTransferService = class _TicketTransferService {
  constructor() {
    this.http = inject(HttpClient);
    this.BASE = "/TicketTransfers";
  }
  initiate(request) {
    return this.http.post(this.BASE, request);
  }
  accept(token) {
    return this.http.post(`${this.BASE}/accept/${token}`, {});
  }
  cancel(id) {
    return this.http.delete(`${this.BASE}/${id}`);
  }
  getSent() {
    return this.http.get(`${this.BASE}/sent`);
  }
  getPending() {
    return this.http.get(`${this.BASE}/pending`);
  }
  static {
    this.\u0275fac = function TicketTransferService_Factory(t) {
      return new (t || _TicketTransferService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TicketTransferService, factory: _TicketTransferService.\u0275fac, providedIn: "root" });
  }
};

// src/app/features/ticket-transfers/ticket-transfers.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function TicketTransfersComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 14);
  }
}
function TicketTransfersComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "send");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, " Iniciar Transfer\xEAncia ");
  }
}
function TicketTransfersComponent_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
...
function TicketTransfersComponent_Conditional_42_For_3_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 27);
    \u0275\u0275listener("click", function TicketTransfersComponent_Conditional_42_For_3_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const t_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.cancel(t_r2.id));
    });
...
function TicketTransfersComponent_Conditional_42_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 21)(1, "div", 22)(2, "div")(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "div", 23)(7, "mat-icon");
    \u0275\u0275text(8, "email");
    \u0275\u0275elementEnd();
    \u0275\u0275text(9);
    \u0275\u0275pipe(10, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 24)(12, "mat-chip", 25);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, TicketTransfersComponent_Conditional_42_For_3_Conditional_14_Template, 3, 0, "button", 26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(t_r2.ticketTypeName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" \u2014 ", t_r2.eventTitle, " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" ", t_r2.toEmail, " \u2022 ", \u0275\u0275pipeBind2(10, 7, t_r2.createdAt, "dd/MM/yyyy HH:mm"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("color", ctx_r2.getStatusColor(t_r2.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.getStatusLabel(t_r2.status));
    \u0275\u0275advance();
    \u0275\u0275conditional(14, t_r2.status === ctx_r2.TicketTransferStatus.Pending ? 14 : -1);
  }
}
function TicketTransfersComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h3");
    \u0275\u0275text(1, "Transfer\xEAncias Enviadas");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(2, TicketTransfersComponent_Conditional_42_For_3_Template, 15, 10, "mat-card", 21, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.sentTransfers);
  }
}
function TicketTransfersComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275element(1, "mat-progress-spinner", 20);
    \u0275\u0275elementEnd();
...
function TicketTransfersComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 28)(1, "mat-icon");
    \u0275\u0275text(2, "inbox");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "Nenhuma transfer\xEAncia pendente para voc\xEA.");
    \u0275\u0275elementEnd()();
  }
}
function TicketTransfersComponent_Conditional_47_For_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 31);
  }
}
function TicketTransfersComponent_Conditional_47_For_1_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "check");
    \u0275\u0275elementEnd();
...
function TicketTransfersComponent_Conditional_47_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-card", 29)(1, "div", 22)(2, "div")(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "div", 23)(7, "mat-icon");
    ...
    \u0275\u0275listener("click", function TicketTransfersComponent_Conditional_47_For_1_Template_button_click_11_listener() {
      const t_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.accept(t_r5.token));
    });
    \u0275\u0275template(12, TicketTransfersComponent_Conditional_47_For_1_Conditional_12_Template, 1, 0, "mat-progress-spinner", 31)(13, TicketTransfersComponent_Conditional_47_For_1_Conditional_13_Template, 3, 0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(t_r5.ticketTypeName);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" \u2014 ", t_r5.eventTitle, " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" De: ", t_r5.fromUserName, " \u2022 ", \u0275\u0275pipeBind2(10, 6, t_r5.createdAt, "dd/MM/yyyy HH:mm"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.accepting === t_r5.id);
    \u0275\u0275advance();
    \u0275\u0275conditional(12, ctx_r2.accepting === t_r5.id ? 12 : 13);
  }
}
function TicketTransfersComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, TicketTransfersComponent_Conditional_47_For_1_Template, 14, 9, "mat-card", 29, _forTrack0);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275repeater(ctx_r2.pendingTransfers);
  }
}
function TicketTransfersComponent_Conditional_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 14);
  }
}
function TicketTransfersComponent_Conditional_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "lock_open");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, " Aceitar Transfer\xEAncia ");
  }
}
var TicketTransfersComponent = class _TicketTransfersComponent {
  constructor() {
    this.service = inject(TicketTransferService);
  ...
  initiate() {
    ...
    this.service.initiate({ ticketId: v.ticketId, toEmail: v.toEmail }).subscribe({
      next: (t) => {
        ...
        this.form.reset();
        this.sending = false;
        this.snackBar.open('Transfer\xEAncia iniciada! O destinat\xE1rio pode aceitar em "Recebidas".', "OK", { duration: 4e3 });
      },
      error: () => {
        this.sending = false;
      }
  ...
  accept(token) {
    ...
    this.service.accept(token).subscribe({
      next: () => {
        ...
        this.accepting = null;
        this.snackBar.open("Ingresso transferido com sucesso!", "OK", { duration: 3e3 });
      },
      error: () => {
        this.accepting = null;
      }
  ...
  cancel(id) {
    this.service.cancel(id).subscribe({
      next: () => {
        ...
        if (t)
          t.status = TicketTransferStatus.Cancelled;
        this.snackBar.open("Transfer\xEAncia cancelada.", "OK", { duration: 2e3 });
      }
    });
  }
  ...
  static {
    this.\u0275fac = function TicketTransfersComponent_Factory(t) {
      return new (t || _TicketTransfersComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TicketTransfersComponent, selectors: [["app-ticket-transfers"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 64, vars: 9, consts: [[1, "container", "page-container"], [1, "page-header"], [1, "section-title"], ["mat-button", "", "routerLink", "/my-tickets"], ["label", "Transferir Ingresso"], [1, "tab-content"], [1, "form-card"], [3, "ngSubmit", "formGroup"], ["appearance", "outline", 1, "full-width"], ["matInput", "", "type", "number", "formControlName", "ticketId", "placeholder", "Veja em Meus Ingressos"], ["matSuffix", ""], ["matInput", "", "type", "email", "formControlName", "toEmail", "placeholder", "email@exemplo.com"], [1, "info-box"], ["mat-raised-button", "", "color", "primary", "type", "submit", 1, "full-width", 3, "disabled"], ["diameter", "20", "mode", "indeterminate"], [2, "text-align", "center", "padding", "32px"], [3, "label"], [2, "margin", "24px 0"], ["matInput", "", "formControlName", "token", "placeholder", "Cole o token recebido"], ["mat-raised-button", "", "color", "accent", "type", "submit", 1, "full-width", 3, "disabled"], ["mode", "indeterminate"], [1, "transfer-card"], [1, "transfer-row"], [1, "transfer-meta"], [1, "transfer-actions"], ["highlighted", "", 3, "color"], ["mat-icon-button", "", "color", "warn", "title", "Cancelar"], ["mat-icon-button", "", "color", "warn", "title", "Cancelar", 3, "click"], [1, "empty-card"], [1, "transfer-card", "pending-card"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "18", "mode", "indeterminate"]], template: function TicketTransfersComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
        \u0275\u0275text(3, "Transfer\xEAncias de Ingresso");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(4, "a", 3)(5, "mat-icon");
        \u0275\u0275text(6, "arrow_back");
        \u0275\u0275elementEnd();
        \u0275\u0275text(7, " Meus Ingressos");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "mat-tab-group")(9, "mat-tab", 4)(10, "div", 5)(11, "mat-card", 6)(12, "mat-card-header")(13, "mat-card-title");
        \u0275\u0275text(14, "Transferir para outra pessoa");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "mat-card-subtitle");
        \u0275\u0275text(16, "O destinat\xE1rio receber\xE1 um link para aceitar o ingresso");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(17, "mat-card-content")(18, "form", 7);
        \u0275\u0275listener("ngSubmit", function TicketTransfersComponent_Template_form_ngSubmit_18_listener() {
          return ctx.initiate();
        });
        \u0275\u0275elementStart(19, "mat-form-field", 8)(20, "mat-label");
        \u0275\u0275text(21, "ID do Ingresso");
        \u0275\u0275elementEnd();
        \u0275\u0275element(22, "input", 9);
        \u0275\u0275elementStart(23, "mat-icon", 10);
        \u0275\u0275text(24, "qr_code_2");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(25, "mat-hint");
        \u0275\u0275text(26, "Voc\xEA pode ver o ID na p\xE1gina Meus Ingressos");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(27, "mat-form-field", 8)(28, "mat-label");
        \u0275\u0275text(29, "E-mail do destinat\xE1rio");
        \u0275\u0275elementEnd();
        \u0275\u0275element(30, "input", 11);
        \u0275\u0275elementStart(31, "mat-icon", 10);
        \u0275\u0275text(32, "email");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(33, "div", 12)(34, "mat-icon");
        \u0275\u0275text(35, "info");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "p");
        \u0275\u0275text(37, "O ingresso ficar\xE1 em seu nome at\xE9 que o destinat\xE1rio aceite a transfer\xEAncia. Voc\xEA pode cancelar antes da aceita\xE7\xE3o.");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(38, "button", 13);
        \u0275\u0275template(39, TicketTransfersComponent_Conditional_39_Template, 1, 0, "mat-progress-spinner", 14)(40, TicketTransfersComponent_Conditional_40_Template, 3, 0);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(41, TicketTransfersComponent_Conditional_41_Template, 2, 0, "div", 15)(42, TicketTransfersComponent_Conditional_42_Template, 4, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(43, "mat-tab", 16)(44, "div", 5);
        \u0275\u0275template(45, TicketTransfersComponent_Conditional_45_Template, 2, 0, "div", 15)(46, TicketTransfersComponent_Conditional_46_Template, 5, 0)(47, TicketTransfersComponent_Conditional_47_Template, 2, 0);
        \u0275\u0275element(48, "mat-divider", 17);
        \u0275\u0275elementStart(49, "mat-card", 6)(50, "mat-card-header")(51, "mat-card-title");
        \u0275\u0275text(52, "Aceitar por Token");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(53, "mat-card-subtitle");
        \u0275\u0275text(54, "Caso tenha recebido um link de transfer\xEAncia");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(55, "mat-card-content")(56, "form", 7);
        \u0275\u0275listener("ngSubmit", function TicketTransfersComponent_Template_form_ngSubmit_56_listener() {
          return ctx.acceptByToken();
        });
        \u0275\u0275elementStart(57, "mat-form-field", 8)(58, "mat-label");
        \u0275\u0275text(59, "Token de Transfer\xEAncia");
        \u0275\u0275elementEnd();
        \u0275\u0275element(60, "input", 18);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(61, "button", 19);
        \u0275\u0275template(62, TicketTransfersComponent_Conditional_62_Template, 1, 0, "mat-progress-spinner", 14)(63, TicketTransfersComponent_Conditional_63_Template, 3, 0);
        \u0275\u0275elementEnd()()()()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(18);
        ...
        \u0275\u0275advance(20);
        \u0275\u0275property("disabled", ctx.form.invalid || ctx.sending);
        \u0275\u0275advance();
        \u0275\u0275conditional(39, ctx.sending ? 39 : 40);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(41, ctx.sentLoading ? 41 : ctx.sentTransfers.length > 0 ? 42 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275property("label", ctx.pendingTransfers.length > 0 ? "Recebidas (" + ctx.pendingTransfers.length + ")" : "Recebidas");
        \u0275\u0275advance(2);
        \u0275\u0275conditional(45, ctx.pendingLoading ? 45 : ctx.pendingTransfers.length === 0 ? 46 : 47);
        \u0275\u0275advance(11);
        \u0275\u0275property("formGroup", ctx.tokenForm);
        \u0275\u0275advance(5);
        \u0275\u0275property("disabled", ctx.tokenForm.invalid || ctx.acceptingToken);
        \u0275\u0275advance();
        \u0275\u0275conditional(62, ctx.acceptingToken ? 62 : 63);
      }
    }, dependencies: [CommonModule, DatePipe, RouterLink, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatCardModule, MatCard, MatCardContent, MatCardHeader, MatCardSubtitle, MatCardTitle, MatButtonModule, MatAnchor, MatButton, MatIconButton, MatIconModule, MatIcon, MatFormFieldModule, MatFormField, MatLabel, MatHint, MatSuffix, MatInputModule, MatInput, MatTabsModule, MatTab, MatTabGroup, MatProgressSpinnerModule, MatProgressSpinner, MatSnackBarModule, MatChipsModule, MatChip, MatDividerModule, MatDivider], styles: ["\n\n.page-container[_ngcontent-%COMP%] {\n  padding: 32px 16px;\n}\n.page-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 32px;\n}\n.tab-content[_ngcontent-%COMP%] {\n  padding: 24px 0;\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  max-width: 640px;\n}\n.form-card[_ngcontent-%COMP%] {\n  padding: 8px;\n}\nform[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  margin-top: 8px;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.info-box[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: flex-start;\n  gap: 8px;\n  background: #e3f2fd;\n  border-radius: 8px;\n  padding: 12px;\n}\n.info-box[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: #0288d1;\n  flex-shrink: 0;\n  font-size: 18px;\n  width: 18px;\n  height: 18px;\n}\n.info-box[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.85rem;\n  color: #01579b;\n}\n.transfer-card[_ngcontent-%COMP%] {\n  padding: 16px;\n}\n.pending-card[_ngcontent-%COMP%] {\n  border-left: 4px solid #6200ea;\n}\n.transfer-row[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  gap: 12px;\n  flex-wrap: wrap;\n}\n.transfer-meta[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n  color: #757575;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n  margin-top: 4px;\n}\n.transfer-meta[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 14px;\n  width: 14px;\n  height: 14px;\n}\n.transfer-actions[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-shrink: 0;\n}\n.empty-card[_ngcontent-%COMP%] {\n  text-align: center;\n  padding: 48px;\n}\n.empty-card[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 48px;\n  width: 48px;\n  height: 48px;\n  color: #bdbdbd;\n  display: block;\n  margin: 0 auto 16px;\n}\n.empty-card[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: #757575;\n}\n/*# sourceMappingURL=ticket-transfers.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TicketTransfersComponent, { className: "TicketTransfersComponent", filePath: "src\\app\\features\\ticket-transfers\\ticket-transfers.component.ts", lineNumber: 181 });
})();
export {
  TicketTransfersComponent
};
//# sourceMappingURL=chunk-C6QZHMHH.js.map
