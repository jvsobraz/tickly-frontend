...
function EventDetailComponent_Conditional_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, EventDetailComponent_Conditional_1_Conditional_20_Conditional_1_Template, 4, 1, "span")(2, EventDetailComponent_Conditional_1_Conditional_20_Conditional_2_Template, 4, 1, "span")(3, EventDetailComponent_Conditional_1_Conditional_20_Conditional_3_Template, 4, 1, "span", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "span");
    \u0275\u0275text(2, "\u26A1 PROMO\xC7\xC3O FLASH");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.getCountdown(ctx.endAt));
  }
}
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const tt_r4 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(2, 3, tt_r4.price, "BRL"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 6, flash_r5.flashPrice, "BRL"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("-", flash_r5.discountType === 0 ? flash_r5.discountValue + "%" : \u0275\u0275pipeBind2(8, 9, flash_r5.discountValue, "BRL"), "");
  }
}
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_53_Conditional_0_For_17_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_53_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275template(1, EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_1_Template, 5, 1, "div", 23);
    \u0275\u0275elementStart(2, "div", 24)(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_5_Template, 2, 1, "p");
    \u0275\u0275elementStart(6, "div", 25);
    \u0275\u0275template(7, EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_7_Template, 9, 12)(8, EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_8_Template, 2, 0)(9, EventDetailComponent_Conditional_1_For_53_Conditional_0_Conditional_9_Template, 3, 4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14, "Qtd");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "mat-select", 28);
    \u0275\u0275twoWayListener("ngModelChange", function EventDetailComponent_Conditional_1_For_53_Conditional_0_Template_mat_select_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275repeaterCreate(16, EventDetailComponent_Conditional_1_For_53_Conditional_0_For_17_Template, 2, 2, "mat-option", 29, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    const tt_r4 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("has-flash", ctx_r1.getFlashSale(tt_r4.id));
    \u0275\u0275advance();
    \u0275\u0275conditional(1, (tmp_13_0 = ctx_r1.getFlashSale(tt_r4.id)) ? 1 : -1, tmp_13_0);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(tt_r4.name);
    \u0275\u0275advance();
    \u0275\u0275conditional(5, tt_r4.description ? 5 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(7, (tmp_16_0 = ctx_r1.getFlashSale(tt_r4.id)) ? 7 : tt_r4.price === 0 ? 8 : 9, tmp_16_0);
    \u0275\u0275advance(4);
...
function EventDetailComponent_Conditional_1_For_53_Conditional_1_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 39);
  }
}
function EventDetailComponent_Conditional_1_For_53_Conditional_1_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function EventDetailComponent_Conditional_1_For_53_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 24)(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_1_For_53_Conditional_1_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const tt_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.joinWaitlist(tt_r4));
    });
    \u0275\u0275template(7, EventDetailComponent_Conditional_1_For_53_Conditional_1_Conditional_7_Template, 1, 0, "mat-progress-spinner", 39)(8, EventDetailComponent_Conditional_1_For_53_Conditional_1_Conditional_8_Template, 3, 0);
    \u0275\u0275elementEnd()();
...
function EventDetailComponent_Conditional_1_For_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, EventDetailComponent_Conditional_1_For_53_Conditional_0_Template, 19, 8)(1, EventDetailComponent_Conditional_1_For_53_Conditional_1_Template, 10, 3);
  }
  if (rf & 2) {
...
function EventDetailComponent_Conditional_1_Conditional_54_For_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", item_r9.quantity, "x ", item_r9.ticketType.name, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 3, item_r9.ticketType.price * item_r9.quantity, "BRL"));
  }
}
function EventDetailComponent_Conditional_1_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 40)(1, "strong");
    \u0275\u0275text(2, "Resumo:");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(3, EventDetailComponent_Conditional_1_Conditional_54_For_4_Template, 6, 6, "div", 41, _forTrack1);
    \u0275\u0275element(5, "mat-divider");
    \u0275\u0275elementStart(6, "div", 42)(7, "strong");
    \u0275\u0275text(8, "Total");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "currency");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 43)(13, "p")(14, "strong");
    \u0275\u0275text(15, "Forma de Pagamento:");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "mat-radio-group", 44);
    \u0275\u0275twoWayListener("ngModelChange", function EventDetailComponent_Conditional_1_Conditional_54_Template_mat_radio_group_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.selectedPaymentMethod, $event) || (ctx_r1.selectedPaymentMethod = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(17, "mat-radio-button", 29)(18, "mat-icon");
    \u0275\u0275text(19, "credit_card");
    \u0275\u0275elementEnd();
    \u0275\u0275text(20, " Cart\xE3o ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "mat-radio-button", 29)(22, "mat-icon");
    \u0275\u0275text(23, "pix");
    \u0275\u0275elementEnd();
    \u0275\u0275text(24, " PIX ");
    \u0275\u0275elementEnd()()();
...
function EventDetailComponent_Conditional_1_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-spinner", 18);
  }
}
function EventDetailComponent_Conditional_1_Conditional_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
...
function EventDetailComponent_Conditional_1_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 19)(1, "a", 45);
    \u0275\u0275text(2, "Entre");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " ou ");
...
function EventDetailComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 11)(35, "h3");
    \u0275\u0275text(36, "Compartilhar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 12)(38, "a", 13)(39, "mat-icon");
    \u0275\u0275text(40, "chat");
    \u0275\u0275elementEnd();
    \u0275\u0275text(41, " WhatsApp ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "button", 14);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_1_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(44, "link");
    \u0275\u0275elementEnd();
    \u0275\u0275text(45, " Copiar link ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(46, "div", 15)(47, "mat-card", 16)(48, "mat-card-header")(49, "mat-card-title");
    \u0275\u0275text(50, "Ingressos");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "mat-card-content");
    \u0275\u0275repeaterCreate(52, EventDetailComponent_Conditional_1_For_53_Template, 2, 1, null, null, _forTrack0);
    \u0275\u0275template(54, EventDetailComponent_Conditional_1_Conditional_54_Template, 25, 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "mat-card-actions")(56, "button", 17);
    \u0275\u0275listener("click", function EventDetailComponent_Conditional_1_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.buyTickets());
    });
    \u0275\u0275template(57, EventDetailComponent_Conditional_1_Conditional_57_Template, 1, 0, "mat-progress-spinner", 18)(58, EventDetailComponent_Conditional_1_Conditional_58_Template, 3, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(59, EventDetailComponent_Conditional_1_Conditional_59_Template, 7, 0, "p", 19);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind4(11, 19, ctx_r1.event.dateTime, "EEEE, dd/MM/yyyy - HH:mm", "", "pt"), "");
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("href", ctx_r1.whatsappShareUrl(), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(14);
    \u0275\u0275repeater(ctx_r1.event.ticketTypes);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(54, ctx_r1.totalItems > 0 ? 54 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r1.totalItems === 0 || ctx_r1.buying);
    \u0275\u0275advance();
    \u0275\u0275conditional(57, ctx_r1.buying ? 57 : 58);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(59, !ctx_r1.authService.isAuthenticated() ? 59 : -1);
  }
}
var EventDetailComponent = class _EventDetailComponent {
  constructor() {
    ...
    this.flashSaleService = inject(FlashSaleService);
  ...
  copyLink() {
    navigator.clipboard.writeText(window.location.href).then(() => this.snackBar.open("Link copiado!", "OK", { duration: 2e3 }));
  }
  buyTickets() {
    if (!this.authService.isAuthenticated()) {
      this.router.navigate(["/login"], { queryParams: { returnUrl: this.router.url } });
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EventDetailComponent, selectors: [["app-event-detail"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 1, consts: [[1, "loading-overlay", 2, "min-height", "100vh"], ["mode", "indeterminate"], [1, "event-banner"], [1, "banner-overlay"], [1, "container"], ["class", "category-badge", 4, "ngIf"], [1, "event-meta-list"], [1, "social-proof-bar"], [1, "container", "event-content"], [1, "event-layout"], [1, "event-description-section"], [1, "share-section"], [1, "share-buttons"], ["mat-raised-button", "", "target", "_blank", "rel", "noopener", 1, "share-whatsapp", 3, "href"], ["mat-stroked-button", "", 1, "share-copy", 3, "click"], [1, "ticket-section"], [1, "ticket-card"], ["mat-raised-button", "", "color", "primary", 1, "full-width", "buy-btn", 3, "click", "disabled"], ["diameter", "20", "mode", "indeterminate"], [1, "login-hint"], [1, "category-badge"], [1, "urgency"], [1, "ticket-type"], [1, "flash-banner"], [1, "ticket-info"], [1, "ticket-price"], [1, "availability"], ["appearance", "outline", 1, "qty-select"], [3, "ngModelChange", "ngModel"], [3, "value"], [1, "flash-countdown"], [1, "price-original"], [1, "price", "price-flash"], [1, "flash-discount"], [1, "price-free"], [1, "price"], [1, "ticket-type", "sold-out"], [1, "sold-out-badge"], ["mat-stroked-button", "", "color", "accent", 3, "click", "disabled"], ["diameter", "16", "mode", "indeterminate"], [1, "order-summary"], [1, "summary-line"], [1, "summary-total"], [1, "payment-method"], [1, "radio-group", 3, "ngModelChange", "ngModel"], ["routerLink", "/login"], ["routerLink", "/register"]], template: function EventDetailComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, EventDetailComponent_Conditional_0_Template, 2, 0, "div", 0)(1, EventDetailComponent_Conditional_1_Template, 60, 24);
      }
      if (rf & 2) {
