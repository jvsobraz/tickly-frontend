...
function NavbarComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Criar Conta");
    \u0275\u0275elementEnd();
  }
}
function NavbarComponent_Conditional_12_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function NavbarComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2, "qr_code_2");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " Meus Ingressos ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, NavbarComponent_Conditional_12_Conditional_4_Template, 4, 0, "a", 9);
    \u0275\u0275elementStart(5, "button", 10)(6, "mat-icon");
    \u0275\u0275text(7, "account_circle");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-menu", null, 0)(10, "div", 11)(11, "strong");
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementStart(16, "a", 12)(17, "mat-icon");
    \u0275\u0275text(18, "hourglass_top");
    \u0275\u0275elementEnd();
    \u0275\u0275text(19, " Lista de Espera ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "a", 13)(21, "mat-icon");
    \u0275\u0275text(22, "stars");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    let tmp_4_0;
    let tmp_5_0;
    const userMenu_r3 = \u0275\u0275reference(9);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275conditional(4, ctx_r1.authService.isOrganizer() ? 4 : -1);
    \u0275\u0275advance();
...
var NavbarComponent = class _NavbarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 1, consts: [["userMenu", "matMenu"], ["color", "primary", 1, "navbar"], ["routerLink", "/", 1, "brand"], [1, "spacer"], ["mat-button", "", "routerLink", "/events", "routerLinkActive", "active"], ["mat-button", "", "routerLink", "/resale", "routerLinkActive", "active"], ["mat-button", "", "routerLink", "/login"], ["mat-raised-button", "", "routerLink", "/register"], ["mat-button", "", "routerLink", "/my-tickets"], ["mat-button", "", "routerLink", "/admin"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], [1, "user-info"], ["mat-menu-item", "", "routerLink", "/my-waitlist"], ["mat-menu-item", "", "routerLink", "/loyalty"], ["mat-menu-item", "", 3, "click"], ["mat-menu-item", "", "routerLink", "/admin/analytics"], ["mat-menu-item", "", "routerLink", "/admin/affiliates"], ["mat-menu-item", "", "routerLink", "/admin/coupons"]], template: function NavbarComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(11);
        \u0275\u0275conditional(11, !ctx.authService.isAuthenticated() ? 11 : 12);
      }
    }, dependencies: [
      CommonModule,
      RouterLink,
...
var FooterComponent = class _FooterComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 15, vars: 1, consts: [[1, "footer"], [1, "container"], [1, "footer-content"], [1, "footer-brand"], [1, "footer-links"], ["routerLink", "/events"], ["routerLink", "/register"], [1, "footer-copy"]], template: function FooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "footer", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "mat-icon");
        \u0275\u0275text(5, "confirmation_number");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "span");
        \u0275\u0275text(7, "TicketPlatform");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "div", 4)(9, "a", 5);
        \u0275\u0275text(10, "Eventos");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "a", 6);
        \u0275\u0275text(12, "Seja um Organizador");
        \u0275\u0275elementEnd()();
    ...
    }, dependencies: [MatIconModule, MatIcon, RouterLink], styles: ["\n\n.footer[_ngcontent-%COMP%] {\n  background: #212121;\n  color: #bdbdbd;\n  padding: 32px 0;\n  margin-top: 48px;\n}\n.footer-content[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 16px;\n}\n.footer-brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  color: white;\n  font-size: 1.2rem;\n  font-weight: 700;\n}\n.footer-links[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 24px;\n}\n.footer-links[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  color: #bdbdbd;\n  text-decoration: none;\n}\n.footer-links[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  color: white;\n}\n.footer-copy[_ngcontent-%COMP%] {\n  font-size: 0.85rem;\n  margin: 0;\n}\n/*# sourceMappingURL=footer.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src\\app\\shared\\footer\\footer.component.ts", lineNumber: 35 });
})();
