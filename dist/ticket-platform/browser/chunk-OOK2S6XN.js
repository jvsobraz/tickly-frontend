...
function AdminComponent_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_Conditional_58_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_Conditional_59_th_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_Conditional_59_td_3_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_Conditional_59_th_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 30);
    \u0275\u0275text(1, "Data");
    \u0275\u0275elementEnd();
...
function AdminComponent_Conditional_59_td_6_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminComponent_Conditional_59_th_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 30);
    \u0275\u0275text(1, "Status");
    \u0275\u0275elementEnd();
...
function AdminComponent_Conditional_59_td_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 31)(1, "mat-chip");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AdminComponent_Conditional_59_th_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 30);
    \u0275\u0275text(1, "Vendidos");
    \u0275\u0275elementEnd();
...
function AdminComponent_Conditional_59_td_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 31);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AdminComponent_Conditional_59_th_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 30);
...
function AdminComponent_Conditional_59_td_15_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Gr\xE1tis ");
  }
}
function AdminComponent_Conditional_59_td_15_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "currency");
  }
...
function AdminComponent_Conditional_59_td_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 31);
    \u0275\u0275template(1, AdminComponent_Conditional_59_td_15_Conditional_1_Template, 1, 0)(2, AdminComponent_Conditional_59_td_15_Conditional_2_Template, 2, 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminComponent_Conditional_59_th_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 30);
...
function AdminComponent_Conditional_59_td_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 31)(1, "a", 32)(2, "mat-icon");
    \u0275\u0275text(3, "visibility");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "button", 33);
    \u0275\u0275listener("click", function AdminComponent_Conditional_59_td_18_Template_button_click_4_listener() {
...
function AdminComponent_Conditional_59_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 34);
  }
}
function AdminComponent_Conditional_59_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 35);
  }
}
function AdminComponent_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 19);
    \u0275\u0275elementContainerStart(1, 20);
    \u0275\u0275template(2, AdminComponent_Conditional_59_th_2_Template, 2, 0, "th", 21)(3, AdminComponent_Conditional_59_td_3_Template, 6, 3, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(4, 23);
    \u0275\u0275template(5, AdminComponent_Conditional_59_th_5_Template, 2, 0, "th", 21)(6, AdminComponent_Conditional_59_td_6_Template, 3, 4, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(7, 24);
    \u0275\u0275template(8, AdminComponent_Conditional_59_th_8_Template, 2, 0, "th", 21)(9, AdminComponent_Conditional_59_td_9_Template, 3, 3, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(10, 25);
    \u0275\u0275template(11, AdminComponent_Conditional_59_th_11_Template, 2, 0, "th", 21)(12, AdminComponent_Conditional_59_td_12_Template, 2, 1, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(13, 26);
    \u0275\u0275template(14, AdminComponent_Conditional_59_th_14_Template, 2, 0, "th", 21)(15, AdminComponent_Conditional_59_td_15_Template, 3, 1, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(16, 27);
    \u0275\u0275template(17, AdminComponent_Conditional_59_th_17_Template, 2, 0, "th", 21)(18, AdminComponent_Conditional_59_td_18_Template, 7, 4, "td", 22);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(19, AdminComponent_Conditional_59_tr_19_Template, 1, 0, "tr", 28)(20, AdminComponent_Conditional_59_tr_20_Template, 1, 0, "tr", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminComponent, selectors: [["app-admin"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 60, vars: 4, consts: [[1, "container", "page-container"], [1, "page-header"], [1, "section-title"], ["mat-raised-button", "", "color", "primary", "routerLink", "/admin/create-event"], [1, "stats-grid"], [1, "stat-card"], ["color", "primary"], [2, "color", "#ff6d00"], [1, "tools-section"], [1, "tools-title"], [1, "tools-grid"], ["mat-raised-button", "", "routerLink", "/admin/analytics", 1, "tool-btn"], ["mat-raised-button", "", "routerLink", "/admin/affiliates", 1, "tool-btn"], ["mat-raised-button", "", "routerLink", "/admin/coupons", 1, "tool-btn"], [1, "table-card"], [1, "loading-overlay"], ["mode", "indeterminate"], [1, "empty-state"], ["routerLink", "/admin/create-event"], ["mat-table", "", 1, "full-width", 3, "dataSource"], ["matColumnDef", "title"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "dateTime"], ["matColumnDef", "status"], ["matColumnDef", "tickets"], ["matColumnDef", "minPrice"], ["matColumnDef", "actions"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-icon-button", "", "title", "Ver evento", 3, "routerLink"], ["mat-icon-button", "", "color", "warn", "title", "Cancelar", 3, "click", "disabled"], ["mat-header-row", ""], ["mat-row", ""]], template: function AdminComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(51, "Cupons");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(52, "mat-card", 14)(53, "mat-card-header")(54, "mat-card-title");
        \u0275\u0275text(55, "Meus Eventos");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(56, "mat-card-content");
        \u0275\u0275template(57, AdminComponent_Conditional_57_Template, 2, 0, "div", 15)(58, AdminComponent_Conditional_58_Template, 7, 0)(59, AdminComponent_Conditional_59_Template, 21, 3);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
        ...
        \u0275\u0275advance(27);
        \u0275\u0275conditional(57, ctx.loading ? 57 : ctx.events.length === 0 ? 58 : 59);
      }
    }, dependencies: [
      CommonModule,
      CurrencyPipe,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminComponent, { className: "AdminComponent", filePath: "src\\app\\features\\admin\\admin.component.ts", lineNumber: 165 });
})();
export {
  AdminComponent
};
//# sourceMappingURL=chunk-OOK2S6XN.js.map
